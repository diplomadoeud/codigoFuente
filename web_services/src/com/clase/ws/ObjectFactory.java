 ...
 * generated in the com.clase.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _Operacion_QNAME = new QName("http://ws.clase.com/", "operacion");
    private final static QName _OperacionResponse_QNAME = new QName("http://ws.clase.com/", "operacionResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.clase.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.clase.com/", name = "operacion")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.clase.com/", name = "operacionResponse")
